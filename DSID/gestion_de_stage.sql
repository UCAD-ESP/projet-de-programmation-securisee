...
CREATE TABLE demande(
	...
	Telephone int(2),
	Email varchar(50),
	Decision ENUM('Accepter', 'Attente'),
...
INSERT INTO bureau (Code, Nom) VALUES 
	(1, 'Bureau des Etudes et du Développement'),
 	(2, 'Bureau Informatique et Production'),
	(3, 'Bureau administratif et financier'),
 	(4, 'Bureau d\'Analyse et d\'Aide à la Décision'),
 	(5, 'Bureau de la Comptabilité et des Statistiques');
